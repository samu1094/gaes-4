					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Carrito</h1>
								<h3 style="color: aliceblue;">Aqui podras ver una simulacion de lo que seria la compra del producto.</h3>
							</div>
						</div>
						<div class="col-lg-7">
                      ...
                      <tbody>
                        <tr>
                          <td class="product-thumbnail">
                            <img src="images/sofa2.jpg" alt="Image" class="img-fluid">
                          </td>
                          <td class="product-name">
                            <h2 class="h5 text-black">Sofá tipo reclino</h2>
                          </td>
                          <td>$245.000</td>
                          <td>
                        ...
                        <tr>
                          <td class="product-thumbnail">
                            <img src="images/sofa4.jpg" alt="Image" class="img-fluid">
                          </td>
                          <td class="product-name">
                            <h2 class="h5 text-black">Sofá clásico.</h2>
                          </td>
                          <td>$580.000</td>
                          <td>
                            <div class="input-group mb-3 d-flex align-items-center quantity-container" style="max-width: 120px;">
                ...
                <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <p>Escribe el codigo del cupón</p>
                    </div>
                    <div class="col-md-8 mb-3 mb-md-0">
                      <input type="text" class="form-control py-3" id="coupon" placeholder="Codigo del cupón">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-7">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-md-6 text-right">
                          <strong class="text-black">$825.000</strong>
                        </div>
                      </div>
                      <div class="row mb-5">
                        <div class="col-md-6">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <button class="btn btn-black btn-lg py-3 btn-block" onclick="window.location='checkout.html'">Proceder con el pago</button>
                        </div>
                      </div>
                    </div>
                  </div>
