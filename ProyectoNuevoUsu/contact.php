			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li class="active"><a class="nav-link" href="contact.php">Contactanos</a></li>
					</ul>
					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Contactos</h1>
								<p class="mb-4">Aqui podras encontrar, todo sobre nostros.</p>
								<p><a href="" class="btn btn-secondary me-2">Tienda</a>
							</div>
						</div>
						<div class="col-lg-7">
            ...
            <div class="col-md-8 col-lg-8 pb-4">
              ...
              <form>
                ...
                <div class="form-group mb-5">
                  <label class="text-black" for="message">Sugerencia o Mensaje</label>
